...
void save_data_to_file(unsigned char* buff, int length, char const* file)
{
...
int main(int argc, char const* argv[])
{
    ...
    patchData = (TByte*)malloc(500*1024);
    ...
    if (crc != newcrc)
    {
        ...
        save_data_to_file(oldData, newsize, newname);
    }
    fclose(oldfile);
    fclose(patchfile);
    return 0;
